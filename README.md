...
- Primeros experimentos relacionados con la **Task 3**, incluyendo:
  - construcción de trayectorias con changepoint  
...
- generación de trayectorias sintéticas mediante `datasets_theory`
- análisis visual de las trayectorias
- cálculo de la **MSD (Mean Squared Displacement)**
- representación en escala log-log para estudiar leyes de potencia

---

## ⚠️ Observaciones importantes

Se observa que diferentes modelos pueden compartir la misma ley de escala:

$$
\mathrm{MSD}(t) \sim t^\alpha
$$

lo que implica que la estimación del exponente $\alpha$ no es suficiente para identificar el modelo subyacente.
...
- desarrollar métodos automáticos de detección de changepoints
- mejorar la estimación del exponente $\alpha$
- aplicar técnicas de aprendizaje automático para clasificar trayectorias

---

## 📚 Referencia

Muñoz-Gil et al. (2021)  
